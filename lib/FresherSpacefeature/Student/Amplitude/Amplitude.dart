...
class Amplitudepage extends StatefulWidget {
  int RCount;
  String skill;
  Amplitudepage({required this.skill, required this.RCount});
  @override
  _CareerPg createState() => _CareerPg();
}

class _CareerPg extends State<Amplitudepage> {
  unitList(Height) {
    return StreamBuilder<DocumentSnapshot>(
        stream: FirebaseFirestore.instance
            .collection('Amplitude')
            .doc('skill' + widget.RCount.toString())
