...
class studentNotes extends StatefulWidget {
  int sem;
  String subject;
  studentNotes({required this.sem, required this.subject});
  @override
                                ...
                                GestureDetector(
                                  onTap: () async {
                                    ...
                                    if (mp == null) {
                                      ...
                                      print(mp);
                                      print(mp['favourites'][values[i]]);
                                      print(values[i]);
                                      if (mp['favourites'][values[i]] != null) {
                                        mp['favourites'].remove(values[i]);
                                      } else {
